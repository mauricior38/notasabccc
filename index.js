...
app.get("/notasAnimalTelao", async (req, res) => {
    const url="https://ws01.cavalocrioulo.org.br/wsrest/jfrmservices/evento/notasAnimalTelao";
    ...
    const caminhoArquivo = path.join(dir, `notasAnimalTelao.xml`);
...
// Notas Animal em Pista
app.get("/animalEmPista", async (req, res) => {
    const url = 'https://ws01.cavalocrioulo.org.br/wsrest/jfrmservices/evt/dadosAnimalPista'
    const agendamento = req.query.agendamento;
  ...
  // Ranking Femea Morfologia
  // https://ws01.cavalocrioulo.org.br/wsrest/jfrmservices/evt/ranking/25565/FEMEA/MORFOLOGIA
app.get("/ranking", async (req, res) => {
    const url = 'https://ws01.cavalocrioulo.org.br/wsrest/jfrmservices/evt/ranking'
